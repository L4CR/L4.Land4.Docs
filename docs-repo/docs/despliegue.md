...
| :--- | :--- | :--- | :--- |
| **Local** | Validar cambios antes del Pull Request. | Docker Compose + Ruby 3.3 + Jekyll. | [http://localhost:4003/L4.Land4.Docs/](http://localhost:4003/L4.Land4.Docs/) |
...
| **Producción** | Publicar el portal central para consulta del equipo. | GitHub Pages después de fusionar en `main`. | [https://l4cr.github.io/L4.Land4.Docs/](https://l4cr.github.io/L4.Land4.Docs/) |
...
5. Abre el portal en:
   ...
   [http://localhost:4003/L4.Land4.Docs/](http://localhost:4003/L4.Land4.Docs/)
...
| URL base productiva | `https://l4cr.github.io/L4.Land4.Docs/` |
| Destination | `./_site` |
...
*   La página principal carga correctamente en [https://l4cr.github.io/L4.Land4.Docs/](https://l4cr.github.io/L4.Land4.Docs/).
...
*   Las páginas técnicas principales cargan correctamente:
    *   [Arquitectura](https://l4cr.github.io/L4.Land4.Docs/docs/arquitectura.html)
    *   [Despliegue](https://l4cr.github.io/L4.Land4.Docs/docs/despliegue.html)
    *   [Catálogo de Repositorios](https://l4cr.github.io/L4.Land4.Docs/docs/repositorios/)
