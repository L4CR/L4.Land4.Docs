...
En esta sección se consolidan los requerimientos, flujos lógicos y casos de uso expresados en **lenguaje de negocio**. 

A diferencia de la carpeta `/docs` (que está orientada a la implementación técnica y arquitectura de software), la carpeta `/req` sirve como puente de comunicación entre el equipo de Producto, Operaciones y Desarrollo.
