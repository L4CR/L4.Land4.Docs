...
En LAND4, los casos de prueba conectan la intención de negocio con la validación técnica y funcional del sistema. No reemplazan el **Caso de Uso**, la **Historia de Usuario** ni los **Criterios de Aceptación**; los aterrizan en verificaciones ejecutables.
