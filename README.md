...
1. **Portal Central (Este repositorio):** Contiene onboarding, políticas globales, guías de estilo comunes y el [Catálogo de Sistemas](repositorios.md).
2. **Docs Vivas (En cada repositorio):** La documentación detallada e instalación técnica de cada proyecto vive directamente en el directorio `/docs` de su propio repositorio.
